...
class task_config:
    ...
    class curriculum:
        ...
        def get_obstacle_count_behind_gate(level):
            from aerial_gym.config.task_config.curriculum_schedules import get_obstacle_count_behind_gate
        ...
        def get_static_camera_difficulty(level):
            from aerial_gym.config.task_config.curriculum_schedules import get_static_camera_difficulty
            return get_static_camera_difficulty(level)

        
        @staticmethod
        def get_dynamic_camera_follow_offset():
            from aerial_gym.config.task_config.curriculum_schedules import get_dynamic_camera_follow_offset
