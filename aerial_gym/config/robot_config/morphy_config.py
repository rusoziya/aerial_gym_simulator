...
class MorphyCfg:
    ...
    class reconfiguration_config:
        dof_mode = "effort"  # "position", "velocity" or "effort"
    ...
    class robot_asset:
        asset_folder = f"{AERIAL_GYM_DIRECTORY}/resources/robots/morphy"
        file = "morphy.urdf"
        name = "base_quadrotor"  # actor name
        base_link_name = "base_link"
        disable_gravity = False
        collapse_fixed_joints = False  # merge bodies connected by fixed joints.
        # set this to True when performing arm SysID for the soft system.
