...
def populate_obstacle_tensors(
    ...
    global_tensor_dict.obstacle_position = global_tensor_dict.env_asset_state_tensor[:, :, 0:3]
    global_tensor_dict.obstacle_orientation = global_tensor_dict.env_asset_state_tensor[:, :, 3:7]
