...
# Run inference for static yaw-sweeping camera modality across multiple levels and seeds
# Levels: 3, 13, 23, 33
...
POLICY_SUBDIR="drone_and_static_sweeping_curriculum_L13_23_TEST6"
...
echo "Starting sweeping-camera inference runs..."

for SEED in "${SEEDS[@]}"; do
  for LVL in "${LEVELS[@]}"; do
    RUN_NAME="sweeping_L${LVL}_SEED${SEED}"
