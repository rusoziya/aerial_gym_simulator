...
# Run inference for dynamic-follow camera modality across multiple levels and seeds
# Levels: 3, 13, 23, 33
...
echo "Starting dynamic-follow camera inference runs..."

for SEED in "${SEEDS[@]}"; do
  for LVL in "${LEVELS[@]}"; do
    RUN_NAME="dynamic_follow_L${LVL}_SEED${SEED}"
