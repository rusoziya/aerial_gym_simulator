...
# Run inference for Moving Peer Cam - Arc Follow modality across multiple levels and seeds
# Levels: 3, 13, 23, 33
...
POLICY_SUBDIR="drone_and_static_arc_following_curriculum_L13_23_4"
...
echo "Starting arc-follow camera inference runs..."

for SEED in "${SEEDS[@]}"; do
  for LVL in "${LEVELS[@]}"; do
    RUN_NAME="arc_follow_L${LVL}_SEED${SEED}"
