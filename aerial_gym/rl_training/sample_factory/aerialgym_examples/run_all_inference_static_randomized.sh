...
# Run inference for Static camera (no sweep/lock/arc, randomized orientation) across levels and seeds
# Levels: 3, 13, 23, 33
...
POLICY_SUBDIR="drone_and_static_fixed_orientation_2"
...
echo "Starting static-randomized camera inference runs..."

for SEED in "${SEEDS[@]}"; do
  for LVL in "${LEVELS[@]}"; do
    RUN_NAME="static_random_L${LVL}_SEED${SEED}"
