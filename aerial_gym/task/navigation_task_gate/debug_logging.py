...
class NavigationTaskGateDebugMixin:
    """Debug logging methods extracted from NavigationTaskGate.
    
    These are mixed back into NavigationTaskGate via multiple inheritance.
    """
